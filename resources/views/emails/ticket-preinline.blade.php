...
<img src="<?php echo $message->embed( URL::to($company_logo) ); ?>" style="max-width: 200px;">
</td>
<td class="six sub-columns last" style="text-align:right; vertical-align:middle;">
<span class="template-label"><?php echo $event->title; ?></span>
</td>
...
<p>We're glad to see you're going to <strong><?php echo $ticket->event->title; ?></strong>.</p>
<img width="580" height="326" src="<?php echo $message->embed( URL::to($event->featured_image) ); ?>">
</td>
<td class="expander"></td>
</tr>
</table>
...
<tr>
<td class="panel">
<p>To view your ticket on the web, please go to <a href="<?php echo URL::route('tickets/show', Crypt::encrypt($ticket->id)); ?>">our website! &rarr;</a></p>
</td>
<td class="expander"></td>
</tr>
</table>
		...
		<tr>
			<td>
				...
				<table>
					<tr>
						<td>From: &nbsp;</td>
						<td><?php echo $event->hrStartTime(); ?></td>
					</tr>
					<tr>
						<td>To:</td>
						<td><?php echo $event->hrEndTime(); ?></td>
					</tr>
				</table>
			</td>
		</tr>
...
<td class="wrapper">
	<table class="six columns">
		...
		<td>
			...
			<hr />
			<?php foreach( $event->location->addressAsArray() as $line ){ ?>
...
<tr>
<td>
<a href="<?php echo URL::route('events.show', $event->id); ?>">View The Event</a>
</td>
</tr>
</table>
</td>
