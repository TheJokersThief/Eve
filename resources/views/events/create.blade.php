...
@section('extra-js')
	...
	<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key={{ env('GOOGLE_API_KEY') }}&libraries=places"></script> {{!! Can't test this at the moment, a little worried about this line !!}} {{-- TODO --}}
